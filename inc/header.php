          ...
          <?php if (Session::get('id') == TRUE) { ?>
            <?php if (Session::get('roleid') == '1') { ?>
              <li class="nav-item">
                  ...
                  <a class="nav-link" href="moviesplaylist.php"><i class="fas fa-users mr-2"></i>Movies</span></a>
              </li>
              <li class="nav-item">

                  <a class="nav-link" href="movies.php"><i class="fas fa-search mr-2"></i>search movies</span></a>
              </li>
              <li class="nav-item">

                  <a class="nav-link" href="movielist.php"><i class="fas fa-plus mr-2"></i>Add Movies</span></a>
              </li>
              <li class="nav-item">
